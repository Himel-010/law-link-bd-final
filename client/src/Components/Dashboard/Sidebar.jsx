  ...
  return (
    <aside className="flex h-screen w-[270px] shrink-0 flex-col border-r border-slate-800/60 bg-[#06080F] text-slate-300 shadow-2xl">
      <div className="shrink-0 px-5 pb-4 pt-6">
        <button className="group flex w-full items-center justify-between rounded-2xl border border-white/5 bg-white/[0.02] p-2 transition-all hover:bg-white/[0.05]">
          <div className="flex min-w-0 items-center gap-3">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500 to-cyan-700 text-sm font-black text-white shadow-lg shadow-cyan-500/20">
      ...
      <div className="mt-auto shrink-0 space-y-1 border-t border-slate-800/60 bg-[#06080F]/80 p-4 backdrop-blur-md">
        <button className="group flex w-full items-center gap-3 rounded-xl px-4 py-2.5 text-sm font-medium text-slate-400 transition-colors hover:bg-white/5 hover:text-slate-200">
